...
export default function App() {
  ...
  function showForecastData(response){
    ...
    firstDay: new Date(response.data.list[7].dt * 1000).getDay(),
    ...
    secondDay: new Date(response.data.list[15].dt * 1000).getDay(),
    ...
    thirdDay: new Date(response.data.list[23].dt * 1000).getDay(),
    ...
    fourthDay: new Date(response.data.list[31].dt * 1000).getDay(),
    ...
    fifthDay: new Date(response.data.list[39].dt * 1000).getDay(),
